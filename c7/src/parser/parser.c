...
static const char *const yytname[] =
{
  ...
  "PARENT_LEFT", "PARENT_RIGHT", "READ", "ID", "$accept", "program",
...
#line 27 "parser/c7.y"
                                                        { ; }
#line 1314 "parser/parser.c"
    break;

  case 3:
#line 30 "parser/c7.y"
                                                        { printf("\n\nSYNTAX - %c stmts %c", (yyvsp[-2].op), (yyvsp[0].op)); }
#line 1320 "parser/parser.c"
    break;
