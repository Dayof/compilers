...
yyreduce:
  ...
  switch (yyn)
    {
  case 2:
#line 31 "parser/cppython.y"
                                       { create_empy_ast(); }
#line 1315 "parser/parser.c"
    break;

  case 3:
#line 32 "parser/cppython.y"
                                       { create_ast((yyvsp[0].expression)); }
